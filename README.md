...
![Schematic of a retractable active fin stabilizer system (Source: Wikipedia/CC BY-SA 3.0)](https://upload.wikimedia.org/wikipedia/commons/e/e0/Retractable_fin_stabilizer_schematic_en.png)

*Fig. 1: Schematic illustrating the kinematic principle of a retractable active fin stabilizer system. While industrial vessels use macro-scale fins to move the entire ship, this Proof of Concept (PoC) gimbal explores the analog mathematical and mechatronic challenges—Sensor Fusion, Discrete PID Control—applied to payload stabilization on a micro-scale. (Image source: Wikipedia/CC BY-SA 3.0)*
